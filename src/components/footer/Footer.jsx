...
import appStore from "../../assets/googleStore.png"
import playStore from "../../assets/download-appstore.png"
const Footer = () => {
  return (
    <footer className="bg-black text-white mt-35 pt-20 ">
      <div className="border-b border-b-[#141414] pb-[108px] ">
        <div className="containeer mx-auto flex gap-[87px] ">
        <div className=" flex flex-col gap-4">
            <div className="font-bold text-2xl mt-2 leading-6 tracking-[3%] font-inter">Exclusive</div>
            <p className="font-medium text-xl mt-2 leading-7 tracking-[0%] font-poppins">Subscribe</p>
            <p className="font-normal text-base leading-6 tracking-[0%] font-poppins">Get 10% off your first order</p>
            <div className="w-[217px] flex items-center border px-3 py-3 gap-7 rounded">
                <input className="w-[130px] font-normal text-base leading-6 tracking-[0%] font-poppins outline-none" type="text" placeholder="Enter your email"/>
                <button><SendBtn/></button>
            </div>
        </div>
        <div className="flex flex-col gap-6">
            <p className="font-medium text-xl leading-7 tracking-[0%] font-poppins">Support</p>
            <ul className="max-w-[175px] flex flex-col gap-4">
                <li >
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">111 Bijoy sarani, Dhaka,  DH 1515, Bangladesh.</a>
                </li>
                  <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">exclusive@gmail.com</a>
                </li>
                  <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">+88015-88888-9999</a>
                </li>
            </ul>
        </div>
        <div className="flex flex-col gap-6">
            ...
            <ul className="max-w-[175px] flex flex-col gap-4">
                <li >
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">My Account</a>
                </li>
                  <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Login / Register</a>
                </li>
                  <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Cart</a>
                </li>
                <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Wishlist</a>
                </li>
                <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Shop</a>
                </li>
            </ul>
        </div>
          <div className="flex flex-col gap-6">
            ...
            <ul className="max-w-[175px] flex flex-col gap-4">
                <li >
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Privacy Policy</a>
                </li>
                  <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Terms Of Use</a>
                </li>
                  <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">FAQ</a>
                </li>
                <li>
                    <a className="font-normal text-base leading-6 tracking-[0%] shrink-0 font-poppins" href="#">Contact</a>
                </li>
            </ul>
        </div>
        <div className="flex flex-col gap-6">
        <p className="font-medium text-xl leading-7 tracking-[0%] font-poppins">Download App</p>
            <div>
                <p className="font-medium text-xs leading-[18px] tracking-[0%] font-poppins text-[#AFAFAF]">Save $3 with App New User Only</p>
...
<a href="#"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_16521_1563)">
...
<path d="M11.5 9.05C12.417 8.113 13.611 7.5 15 7.5C16.4587 7.5 17.8576 8.07946 18.8891 9.11091C19.9205 10.1424 20.5 11.5413 20.5 13V20.5H18.5V13C18.5 12.0717 18.1313 11.1815 17.4749 10.5251C16.8185 9.86875 15.9283 9.5 15 9.5C14.0717 9.5 13.1815 9.86875 12.5251 10.5251C11.8687 11.1815 11.5 12.0717 11.5 13V20.5H9.5V8H11.5V9.05ZM4.5 6C4.10218 6 3.72064 5.84196 3.43934 5.56066C3.15804 5.27936 3 4.89782 3 4.5C3 4.10218 3.15804 3.72064 3.43934 3.43934C3.72064 3.15804 4.10218 3 4.5 3C4.89782 3 5.27936 3.15804 5.56066 3.43934C5.84196 3.72064 6 4.10218 6 4.5C6 4.89782 5.84196 5.27936 5.56066 5.56066C5.27936 5.84196 4.89782 6 4.5 6ZM3.5 8H5.5V20.5H3.5V8Z" fill="white"/>
      ...
      <div className="flex items-center justify-center pt-4 pb-6 gap-1">
        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.5 18.3332C15.1024 18.3332 18.8334 14.6022 18.8334 9.99984C18.8334 5.39746 15.1024 1.6665 10.5 1.6665C5.89765 1.6665 2.16669 5.39746 2.16669 9.99984C2.16669 14.6022 5.89765 18.3332 10.5 18.3332Z" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13 8.14799C13 8.14799 11.9706 6.6665 10.2549 6.6665C8.53924 6.6665 7.16669 8.14799 7.16669 9.99984C7.16669 11.8517 8.53924 13.3332 10.2549 13.3332C11.9706 13.3332 13 11.8517 13 11.8517" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

        <p className="text-[#3D3D3D] font-normal text-base leading-6 tracking-[0%] font-poppins">Copyright Rimel 2022. All right reserved</p>
      </div>
    </footer>
  );
};
